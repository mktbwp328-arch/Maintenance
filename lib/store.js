...
export const STATUSES = ['แจ้งซ่อม', 'ดำเนินการ', 'ส่งซ่อม / รออะไหล่', 'สำเร็จ', 'ปิดงาน', 'ยกเลิก'];
export const PRIORITIES = ['ปกติ', 'เร่งด่วน', 'วิกฤต (หยุดการผลิต)'];
// อนุญาตเปลี่ยนสถานะแบบเดินหน้าเท่านั้น ("ปิดงาน" = ผู้แจ้งยืนยันรับงานผ่านไลน์)
