...
const LIST_COLS = "id,no,reporter,phone,email,dept,equipment_id,equipment_name,location,problem_type,priority,detail,status,assignee,solution,history,created_at,updated_at,closed_at,created_by,(photo is not null and photo <> '') as has_photo";
